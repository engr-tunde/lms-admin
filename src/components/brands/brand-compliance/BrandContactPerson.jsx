const BrandContactPerson = ({ brand }) => {
  return (
        ...
        <div className="w-full h-full px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 bg-gray-100/50 p-4 w-full">
            <div className="col-span-1 flex flex-col gap-1 w-1/2">
              ...
              <span className="text-sm">{brand?.contact?.customer_service_phone || "N/A"}</span>
            </div>
            <div className="col-span-1 flex flex-col gap-1">
              <span className="text-sm font-semibold">Email</span>
              <span className="text-sm">{brand?.contact?.customer_service_email || "N/A"}</span>
            </div>
            <div className="col-span-1 flex flex-col gap-1">
              <span className="text-sm font-semibold">Main contact for logistics</span>
              <span className="text-sm">{(brand?.contact?.logistics_contact) || "N/A"}</span>
            </div>
          </div>
        </div>
      </div>
