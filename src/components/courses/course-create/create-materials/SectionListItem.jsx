...
const SectionListItem = ({ section, index, mutate, disableRemoval, setActiveTab }) => {
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="px-6 py-6 w-full">
        <div className="flex items-start gap-4">
          <button className="mt-1 text-gray-400 hover:text-gray-600 cursor-move w-[3%]">
            ...
            <div className="w-full">
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                ...
                <div className="mt-4 w-full overflow-x-auto">
                  <div className="grid grid-flow-col auto-cols-[18rem] gap-3 pb-2">
