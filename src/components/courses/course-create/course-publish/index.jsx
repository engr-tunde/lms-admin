...
function CoursePublish({ course, onStepComplete }) {
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 space-y-4">
            ...
            <MaterialPreview course={course} />
            <RequirementsPreview course={course} />
          </div>
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              <PricePreview course={course} />
              <SettingsPreview course={course} />
              <PublishStatusCheck course={course} />
              ...
              <div className="space-y-3">
                ...
                <button className="w-full px-6 py-2.5 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors">
                  Save as Draft
                </button>
                <button className="w-full px-6 py-2.5 text-gray-600 hover:text-gray-700 font-medium transition-colors">
                  ← Back to Pricing
                </button>
              </div>
            </div>
