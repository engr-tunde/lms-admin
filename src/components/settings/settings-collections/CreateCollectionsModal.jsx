...
//     collection: Yup.string().required("Please, provide brand collection"),
//   });
...
//           </button>
//         </div>
//           <div className="font-semibold text-sm mb-3">Create Brand collection</div>
//         <Formik
...
const CreateCollectionsModal = ({ show, onClose, }) => {
  ...
  const handleSubmit = async (values) => {
    ...
    const response = await addCollection({ name: values.collection });
