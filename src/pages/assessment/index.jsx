...
import AssessmentCreatePage from "../../components/assessments";

const DashboardAssessmentPage = () => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full h-full">
      ...
      <div className="relative w-full flex flex-col gap-8 bg-gray-50 mx-auto p-10">
        ...
        />
        <AssessmentCreatePage activeTab={activeTab} />
      </div>
    </div>
  )
}

export default DashboardAssessmentPage;
