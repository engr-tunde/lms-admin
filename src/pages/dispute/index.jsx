...
const disputes = [
  ...
  },
  {
    ...
    disputeType: "wrong_item_delivered",
    preferredAction: "cancel_order",
    urgency: "high",
    disputeRequestType: "order",
    status: "open",
   ...
   /////////////////////////////////
  {
    ...
    disputeType: "seller_unresponsive",
    preferredAction: "cancel_order",
    urgency: "high",
    disputeRequestType: "order",
    status: "open",
  ...
  // ===== PAYOUT DISPUTES (4) =====
  {
    ...
    disputeType: "payment_not_confirmed",
    preferredAction: "extend_fulfillment_time",
    urgency: "medium",
  ...
  },
  {
    ...
    disputeType: "incorrect_payout_amount",
    preferredAction: "extend_fulfillment_time",
    urgency: "medium",
    disputeRequestType: "payout",
    status: "resolved",
